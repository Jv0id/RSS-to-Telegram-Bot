...
[![PyPI publish status](https://img.shields.io/github/workflow/status/Jv0id/RSS-to-Telegram-Bot/Publish%20to%20PyPI?label=publish&logo=pypi&logoColor=white)](https://github.com/Jv0id/RSS-to-Telegram-Bot/actions/workflows/publish-to-pypi.yml)
...
[![Build status (master)](https://img.shields.io/github/workflow/status/Jv0id/RSS-to-Telegram-Bot/Publish%20Docker%20image/master?label=build&logo=docker)](https://github.com/Jv0id/RSS-to-Telegram-Bot/actions/workflows/publish-docker-image.yml?query=branch%3Amaster)
[![Build status (dev)](https://img.shields.io/github/workflow/status/Jv0id/RSS-to-Telegram-Bot/Publish%20Docker%20image/dev?label=build%20%28dev%29&logo=docker)](https://github.com/Jv0id/RSS-to-Telegram-Bot/actions/workflows/publish-docker-image.yml?query=branch%3Adev)
